...
class TipoAccionController extends Controller {
   ...
   public function actionDelete() {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('TipoAccion');
    ...
    public function actionAdmin() {
        $model = new TipoAccion('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['TipoAccion']))
            $model->attributes = $_GET['TipoAccion'];
     ...
     * @param TipoAccion $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'tipo-accion-form') {
