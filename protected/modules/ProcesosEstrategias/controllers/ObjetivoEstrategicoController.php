...
class ObjetivoEstrategicoController extends Controller {
    ...
    public function actionCreate() {
        ...
        $model->nombre = $_POST['nombreObjetivo'];
        $model->id_dimension = $_POST['idDimensionObjetivo'];
        $model->codigo = $_POST['codigoDimencion'];
        $model->save();
     ...
     * @return ObjetivoEstrategico the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = ObjetivoEstrategico::model()->findByPk($id);
        if ($model === null)
     ...
     * @param ObjetivoEstrategico $model the model to be validated
     */
