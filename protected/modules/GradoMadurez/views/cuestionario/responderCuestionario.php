                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <label style="margin-left: 30px" >
                                                                        <input type="radio" id="s<?php echo $count; ?>" name="radio<?php echo $count; ?>" class="minimal"/>
                                                                        <span id="label-radio" name="label-radio"> Si</span>
                                                                    </label>
                                                                </td>
                                                                <td>
                                                                    <label style="margin-left: 30px">
                                                                        <input type="radio" id="p<?php echo $count; ?>" name="radio<?php echo $count; ?>" class="minimal"/>
                                                                        <span id="label-radio" name="label-radio"> Parcial </span>
                                                                    </label>
                                                                </td>
                                                                <td>
                                                                    <label style="margin-left: 30px">
                                                                        <input type="radio" id="n<?php echo $count; ?>"  name="radio<?php echo $count; ?>" class="minimal" />
