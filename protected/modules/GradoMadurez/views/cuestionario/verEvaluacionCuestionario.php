    ...
    <div class="toolbar ">
        <div class="col-sm-6 hidden-xs">
            <div class="page-header">
                <h1>
                    Grado  de Madurez: Responder Cuestionario <br>
                    <?php
                    $user = new Usuario();
                ...
                <form novalidate="novalidate" action="<?php echo Yii::app()->getBaseUrl(true) . '/index.php?r=GradoMadurez/cuestionario/evaluacionCuestionario' ?>" role="form" method="post" class="smart-wizard form-horizontal" id="form">
                    <div id="wizard" class="swMain">
                        <ul class="anchor">
                            ...
                            <li>
                                <a rel="3" class="selected" href="#step-3" id="3">
                                    <div class="stepNumber">
                                        3
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 pull-right">
                                                            <div class="actual-date center">
                                                                ...
                                                                <span class="actual-day text-danger"><h1><b><?php echo $evaluacion; ?>/<?php echo $cantidadPreguntas; ?></b></h1></span><br>
