 ...
 */
return array (
  'A role is group of permissions to perform a variety of tasks and operations, for example the authenticated user.' => 'Un rol es un grupo de permisos para llevar a cabo una variedad de tareas y operaciones, por ejemplo, el usuario autenticado',
  'A task is a permission to perform multiple operations, for example accessing a group of controller action.' => 'Una tarea es un permiso para realizar múltiples operaciones, por ejemplo, el acceso a un grupo de acción del controlador',
  'An operation is a permission to perform a single operation, for example accessing a certain controller action.' => 'Una operación es un permiso para realizar una única operación, por ejemplo, acceder a una cierta acción del controlador',
  ...
  'Here you can view which permissions has been assigned to each user.' => 'Aquí puede ver los permisos que se le ha asignado a cada usuario. ',
  'Operations exist below tasks in the authorization hierarchy and can therefore only inherit from other operations.' => 'Existen operaciones por debajo de las tareas en la jerarquía de la autorización y, por tanto, sólo pueden heredar de otras operaciones',
  'Permission :name assigned.' => 'Permiso :name asigando',
  'Permission :name revoked.' => 'Permiso :name revocado',
  'Roles exist at the top of the authorization hierarchy and can therefore inherit from other roles, tasks and/or operations.' => 'Existen roles en la parte superior de la jerarquía de autorización y, por tanto, pueden heredar de otros roles, tareas y / u operaciones.',
  'Source' => '',
  'Tasks exist below roles in the authorization hierarchy and can therefore only inherit from other tasks and/or operations.' => 'Existen tareas a continuación papeles en la jerarquía de autorización y, por tanto, sólo pueden heredar de otras tareas y / u operaciones.',
