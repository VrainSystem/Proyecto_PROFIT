...
class RAuthItemBehavior extends CBehavior
{
	...
	*/
	...
	{
		return CHtml::linkButton(Rights::t('core', ''), array(
	...
	*/
	public function getRevokeAssignmentLink()
	{
                ...
                return CHtml::link('', Yii::app()->createUrl('/rights/assignment/revoke', 
                array("id"=>$this->userId,"name"=>urlencode($this->owner->name))), array("title" => "Eliminar", "style" => "margin-right:5px; color:#595959; ", "class" => "fa fa-trash"));
	}
	...
	*/
	public function getRevokePermissionLink(CAuthItem $role)
	{
		...
		return CHtml::link(Rights::t('core', ''), '#', array(
			'onclick'=>"
				jQuery.ajax({
					type:'POST',
