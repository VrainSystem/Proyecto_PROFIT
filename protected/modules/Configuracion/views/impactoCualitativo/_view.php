...
/* @var $data ImpactoCualitativo */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_impacto_cualitativo')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_impacto_cualitativo), array('view', 'id'=>$data->id_impacto_cualitativo)); ?>
	<br />
