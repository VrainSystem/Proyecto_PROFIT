...
//            'enableBizRuleData' => true,
            'userClass' => 'Usuario', //importar el fichero en la clase RightsModule 
    ...
    'components' => array(
        ...
        'user' => array(
            ...
            'authTimeout' => 1800, //30 min si allowAutoLogin=true
        ),
        'authManager' => array(
...
//         
        ...
        'db' => array(
            'class' => 'CDbConnection',
            'connectionString' => 'pgsql:host=localhost;port=5432;dbname=profit',
//            'emulatePrepare' => true,
            'username' => 'postgres',
            'password' => 'root',
            'charset' => 'utf8',
