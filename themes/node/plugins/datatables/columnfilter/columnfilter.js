...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateColumnSelect(oTable, aData, iColumn, nTh, sLabel, bRegex, oSelected, bMultiselect) {
            ...
            var r = '<select class="js-example-basic-single" style="width:100%;" rel="' + i + '"><option value="" class="search_init">' + sLabel + '</option>';
            if(bMultiselect) {
                r = '<select class="js-example-basic-single" style="width:100%;" rel="' + i + '" multiple>';
            }
            var j = 0;
